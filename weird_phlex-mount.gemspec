...
require_relative "lib/weird_phlex/mount/version"

Gem::Specification.new do |s|
  s.name = "weird_phlex-mount"
  s.version = WeirdPhlex::Mount::VERSION
  s.authors = ["Klaus Weidinger"]
  s.email = ["Klaus Weidinger"]
  s.homepage = "https://github.com/weird-phlex/weird_phlex-mount"
